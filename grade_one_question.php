...
<head>
	...
	<?php
		if($grade=='One'){
			echo'<link rel="stylesheet" href="css/grade1.css" type="text/css">';
		}else if($grade=='two'){
			echo'<link rel="stylesheet" href="css/grade2.css" type="text/css">';
		}else{
	...
	<nav class="navbar navbar-inverse">
        <div class="container">
            <div class="navbar-header">
                <a href="grade_one_question.php"><img src="img/logo.png" height="65px"></a>
            </div>
            <div>
